        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <div className="flex items-center gap-4">
            ...
            <select id="status" className="px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" onChange={(e)=>{
              ...
              <option value="" defaultChecked>Choose Statue</option>
              <option value="Pending">Pending</option>
              <option value="Cancelled">Cancelled</option>
              <option value="Delivered">Delivered</option>
            </select>
            {isLoaded?(  <button className="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition" onClick={update}> 
              Update Status
            </button>):((<ButtonLoaders ty={' '} />))}
